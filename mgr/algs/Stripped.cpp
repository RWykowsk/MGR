...
void Stripped::doBeforeProduct(Candidate *Ck)
{
	groups = new vector<vector<int>*>();
	GroupsNo = Ck->GroupsNo;
}

void Stripped::product(vector<vector<int> *> *A, vector<vector<int> *> *B)
{
	vector<vector<int> > S;
...
bool Stripped::holds(vector<vector<int> *> *C)
{
...
void Stripped::prepareCandidate(vector<Candidate*>& C1)
{
